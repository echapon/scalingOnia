...
void plotMidRap() {
   ...
   th7.set_legend("J/#psi 3PJ8 7TeV |y|<0.75");
   th7.set_graphHwU("th_inputs/ForEmilien/LHC7/direct_psi1S_3PJ8.HwU",0,0);
   ...
   th13.set_legend("J/#psi 3PJ8 13TeV |y|<0.75");
   th13.set_graphHwU("th_inputs/ForEmilien/LHC13/direct_psi1S_3PJ8.HwU",0,0);
   theory.push_back(th13);

   plot(data,theory,"plot_3PJ8");
