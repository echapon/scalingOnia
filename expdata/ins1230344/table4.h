#ifndef ins1230344_table4
#define ins1230344_table4
...
namespace ins1230344table4 {
   // metadata
   string location = "Figure 3,5";
   string dscomment = "The double-differential cross sections for prompt J/PSI production (assuming no polarisation) and         production of J/PSI from b-hadron decays as a function of transverse momentum for the rapidity range 2.5-3.0.         Also shown in the final column is the fraction (in %) of J/PSIs from the latter.";
   ...
   TGraphAsymmErrors* graph_table4_y1(bool stat = false, bool correl=true) {
      TFile *f = new TFile("expdata/ins1230344/HEPData-ins1230344-v1-Table4.root");
...
#endif // #ifndef ins1230344_table4
