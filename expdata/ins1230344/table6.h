#ifndef ins1230344_table6
#define ins1230344_table6
...
namespace ins1230344table6 {
   // metadata
   string location = "Figure 3,5";
   string dscomment = "The double-differential cross sections for prompt J/PSI production (assuming no polarisation) and         production of J/PSI from b-hadron decays as a function of transverse momentum for the rapidity range 3.5-4.0.         Also shown in the final column is the fraction (in %) of J/PSIs from the latter.";
   ...
   TGraphAsymmErrors* graph_table6_y1(bool stat = false, bool correl=true) {
      TFile *f = new TFile("expdata/ins1230344/HEPData-ins1230344-v1-Table6.root");
...
#endif // #ifndef ins1230344_table6
